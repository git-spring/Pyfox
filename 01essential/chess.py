...
def Draw_a_chessboard(screen):
    ...
    s_font = pygame.font.Font('sans.ttf', 45)
...
def Draw_a_chessman(screen, color, qizi, x, y):
    ...
    q_font = pygame.font.Font('sans.ttf', 60)
                    ...
                    if working:
                        ...
                        # 鼠标再次按下，落下棋子
                            ...
                            if r < event.pos[0] < 900 + r and r < event.pos[1] < 810 + r:
                                ...
                                if backups1:  # 红棋
                                    # 判断是否符合走棋规则
                                    if weizhi_able(backups1[0], backups1[1]['color'], backups1[1]['now_weizhi'][0],
                                                   backups1[1]['now_weizhi'][1], x, y) and order:
                                        # 判断所走位置是否有棋子
                                    ...
                                    if weizhi_able(backups2[0], backups2[1]['color'], backups2[1]['now_weizhi'][0],
                                                   backups2[1]['now_weizhi'][1], x, y) and not order:
                                        # 判断所走位置是否有棋子
                                        if weizhi_panduan(x, y):
                                            # 判断是否为敌方棋子
